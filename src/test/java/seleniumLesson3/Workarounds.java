...
public class Workarounds {
    ...
    private final By MENI_ITEM = By.xpath(".//li[contains(@class, 'submenu-lvl1__list-item--has-child')]");
    private final By MENU = By.xpath(".//div[@class = 'submenu-lvl1 submenu-lvl1--invisible submenu-lvl1--index']");
    private final By CATALOG_ITEMS = By.xpath(".//div[contains(@class, 'catalog-taxons-product--grid-view')]");
    ...
    @Test
    public void menuWorkaronds() {
        List<WebElement> menuItems = browser.findElement(MENU).findElements(MENI_ITEM);
    ...
    public void catalogWorkaround() {
        ...
        List<WebElement> catalogItems = browser.findElements(CATALOG_ITEMS);
